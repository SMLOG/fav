...
!(function (e, t) {
  ...
  var t = function () {
    ...
    i = { clear: !0, debug: !0, debugTime: 3e3 };
  var r = (function () {
    function e(e) {
      var r = t(t({}, i), e),
        n = r.clear,
    ...
    return (
        ...
        if ((this._callback || this._redirect || this._write) && window) {
          ...
          if (window.chrome) {
            ...
            (i.toString = function () {
              return (
                e._evalCounts++,
                e._evalCounts === (e._isOpenedEver ? 1 : 2) &&
                  ((e._isOpenedEver = !0), (e._evalCounts = 0), e.fire()),
                t
              );
            }),
      ...
      (e.prototype.fire = function () {
        this._callback
          ...
          : (this.redirect(), this._redirect || this.write());
      }),
